...
// Delete Product
export const deleteProduct = createAsyncThunk('product/addImage', 
        async (id,thunkAPI) => {
            try{
                ...
                const res = await axios.delete(`http://localhost:8083/product/${id}/imagehttp://localhost:8083/admin/product/${id}`,{
                        headers: headers
                })

                thunkAPI.dispatch(getAllProd)
                return res.data
