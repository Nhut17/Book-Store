...
const InfoSignUpForm = ({setShowSignUp}) => {
    ...
    console.log( state.successRegister)
    ...
    const handleOnSubmit = (formData) => {
        const {username,name,phonenumber,email,password,rePassword} = formData
  ...
  return (
    <form onSubmit={handleSubmit(handleOnSubmit)} className='main-form'>
       <div className="main-forms">
                ...
                <button className='btn-sign-up' style={{display: 'flex'}}>ĐĂNG KÝ</button>
                {
                    state.successRegister === false && <span className='err-msg'>{state.message}</span> 
                }
                <div className="login-with" style={{paddingTop: 10}}>
