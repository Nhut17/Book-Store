                ...
                <div className="input-group">
                    <div className="input-username">
                        ...
                        <input 
                            ...
                            {
                                state.message === "Tên tài khoản đã tồn tại! Vui lòng thử lại" && <span className='err-msg'>{state.message}</span> 
                            }
                    ...
                    <div className="input-password">
                        ...
                        <input 
                            ...
                            {
                            errors.password?.type === 'minLength' && <span className='err-msg'>Mời bạn nhập mật khẩu</span>
                            }
                    </div>
