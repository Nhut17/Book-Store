            ...
            <div className="comment-feedback">
                ...
                <div className="box-rating">
                    ...
                    <div className="star-rating">
                        <span>5 <i class="fa-solid fa-star ic"></i></span>
                        <span>4 <i class="fa-solid fa-star ic"></i></span>
                        <span>3 <i class="fa-solid fa-star ic"></i></span>
                        <span>2 <i class="fa-solid fa-star ic"></i></span>
                        <span>1 <i class="fa-solid fa-star ic"></i></span>
                    </div>
                </div>
